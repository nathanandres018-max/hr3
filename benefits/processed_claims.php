<?php
/**
 * processed_claims.php
 * Displays processed/approved claims with receipt links
 * Aligns with pending_claims.php and claim_verification.php
 */
...
function render_sidebar(string $active = 'processed_claims') {
    $links = [
...
<head>
    <meta charset="UTF-8">
    <title>Processed Claims - ViaHale TNVS HR3</title>
...
<div class="layout">
    ...
    <div class="sidenav col-auto p-0">
        <?php render_sidebar('processed_claims'); ?>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div>
                ...
                <p class="topbar-subtitle">View approved and processed reimbursement claims</p>
            </div>
            <div class="profile">
        ...
        <div class="page-content">
            ...
            <div class="stats-section">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?= count($processed_claims) ?></div>
                </div>
                <div class="stat-card">
                    <div class="stat-label">Total Value</div>
                    <div class="stat-value">₱<?= number_format(array_sum(array_column($processed_claims, 'amount')) ?: 0, 2) ?></div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form method="GET" class="filter-section">
                        ...
                        <div class="filter-buttons">
                            ...
                            <a href="processed_claims.php" class="btn btn-secondary btn-sm">
                                            ...
                                            <td>
                                                <div style="font-size: 0.85rem;">
                                                    <?php if (!empty($claim['reviewed_at'])): ?>
                                                        <div><?= date('M d, Y', strtotime($claim['reviewed_at'])) ?></div>
