...
if (empty($timesheets)) {
    $timesheets = [
        [
            ...
            'submitted_at' => '2025-09-15 09:30:00',
            'status' => 'approved'
        ],
        [
            'id' => 2,
            ...
            'period_from' => '2025-09-01',
            'period_to' => '2025-09-15',
            'submitted_at' => '2025-09-15 10:15:00',
            'status' => 'pending'
        ],
        [
            'id' => 3,
            ...
            'period_from' => '2025-09-01',
            'period_to' => '2025-09-15',
            'submitted_at' => '2025-09-15 09:45:00',
            'status' => 'rejected'
        ],
        [
            'id' => 4,
            ...
            'submitted_at' => '2025-08-31 17:00:00',
            'status' => 'approved'
        ]
    ];
}
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="../manager/timesheet_reports.php"><ion-icon name="document-text-outline"></ion-icon>Timesheet Reports</a>
                </nav>
            </div>
            <div class="mb-4">
