...
<head>
    <meta charset="UTF-8">
    <title>Policy & Reports - HR Manager | ViaHale TNVS HR3</title>
    ...
    <style>
        ...
        .dashboard-col { background: #fff; border-radius: 18px; box-shadow: 0 2px 8px rgba(140,140,200,0.07); padding: 1.5rem 1.2rem; flex: 1; min-width: 320px; margin-bottom: 1rem; display: flex; flex-direction: column; gap: 1rem; border: 1px solid #f0f0f0;}
  ...
  <div class="sidebar d-flex flex-column justify-content-between shadow-sm border-end">
    <div>
      ...
      <div class="mb-4">
        ...
        <nav class="nav flex-column">
          <a class="nav-link active" href="policy_reports.php"><ion-icon name="settings-outline"></ion-icon>Policy Management</a>
...
<div class="main-content">
  <div class="topbar d-flex justify-content-between align-items-center mb-3">
    <span class="dashboard-title">Policy & Reports</span>
    <div class="profile">
    ...
    <div class="dashboard-col" style="flex:1.7">
      ...
      <table class="table table-hover align-middle">
        ...
        <tbody>
          ...
          <tr>
            <td>Leave Policy</td>
            <td>Defines leave types, eligibility, and procedure.</td>
          ...
          <tr>
            ...
            <td>Rules for attendance, punctuality, and absences.</td>
            <td><span class="status-badge approved">Active</span></td>
            <td>2025-09-01</td>
            <td>
              <button class="btn btn-sm btn-primary">Edit</button>
          ...
          <tr>
            <td>Claims Policy</td>
            <td>Guidelines for employee claims and reimbursements.</td>
      ...
      <div class="text-end">
        <button class="btn btn-primary">Add New Policy</button>
      </div>
    </div>
    ...
    <div class="dashboard-col" style="flex:1">
      ...
      <form class="mb-3">
        <div class="row g-2">
          ...
          <div class="col-md-6">
            <label for="reportDate" class="form-label">Date Range</label>
            <input type="date" id="reportDateFrom" class="form-control mb-1" placeholder="From">
...
<script>
  // Chart.js demo for Reports (fixed and improved)
